...
-(void) mouseDown:(NSEvent *)theEvent {
    ...
    if (hitObj) {
        if (creator.currObj) {
            [creator writeParametersToCurrentObject];
        }
        creator.currObj = hitObj;
        [self selectObject:creator.currObj];
        [creator readParametersFromCurrentObject];
    }
